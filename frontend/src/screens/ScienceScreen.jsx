...
function ScienceScreen() {
  ...
  const scienceWorksheets = worksheets.filter(worksheet => worksheet.category === 'Science');
      ...
      <div>
        ...
        {is_premium && (
          <div>
            <Worksheet
              subject="Science"
              worksheets={scienceWorksheets} // Pass the filtered worksheets for History category
            />
          </div>
        )}
      </div>
